...
public class SignUpController {
    ...
    public String getForm(NativeWebRequest request, @ModelAttribute User user) {
    	Logger.getLogger(getClass()).debug("Inside getForm()");
        ...
        if (connection != null) {
        	Logger.getLogger(getClass()).debug("Inside Null Connection in SignupController !!");
    ...
    public String registerUser(@ModelAttribute User user) {
    	Logger.getLogger(getClass()).debug("Inside registerUser Controller !!");
